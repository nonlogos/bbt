      ...
      <main>
        <Header>
          <MainNav>
            ...
            <LogoBannerImage
              src={logoBannerImage}
              alt="BTT Lago Vista logo banner"
            />
          </MainNav>
        </Header>
        <HeroBanner ref={comp}>
          <HeroText>
            <HeroTxtH1 className="hero_h1">
              Coming{" "}
              <HeroDisappear className="hero_disappear">Soon</HeroDisappear>
            </HeroTxtH1>
        ...
        <WelcomeSection>
          ...
          <p>
            There’s no losing in Brazilian Jiu Jitsu. You either win or you
            learn
          </p>
        </WelcomeSection>
        <IntroSection>
